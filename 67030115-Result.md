...
#### ตารางยาวมากค่ะแคปไม่หมด

```
root@d73aef38a0f5:/project/lab1_basic_build# idf.py size-files
Executing action: size-files
Running ninja in directory /project/lab1_basic_build/build
Executing "ninja all"...
[1/4] cd /project/lab1_basic_build/build && /opt/esp/python_env/idf6.0_py3.12_env/bin/python /opt/esp/idf/com...b1_basic_build/build/partition_table/partition-table.bin /project/lab1_basic_build/build/lab1_basic_build.bi 
lab1_basic_build.bin binary size 0x27cf0 bytes. Smallest app partition is 0x100000 bytes. 0xd8310 bytes (84%) free.
[1/1] cd /project/lab1_basic_build/build/bootloader && /opt/esp/python_env/idf6.0_py3.12_env/bin/python /opt/...le/check_sizes.py --offset 0x8000 bootloader 0x1000 /project/lab1_basic_build/build/bootloader/bootloader.bi 
Bootloader binary size 0x6680 bytes. 0x980 bytes (8%) free.
[4/4] Completed 'bootloader'Running ninja in directory /project/lab1_basic_build/build
Executing "ninja size-files"...
[0/1] cd /project/lab1_basic_build/build && /opt/esp/tools/cmake/4.0.3/bin/cmake -D "IDF_SIZE_TOOL=/opt/esp/python_env/idf6.0_py3.12_env/bin/python;-m;esp_idf_size" -D IDF_SIZE_MODE=--files -D MAP_FILE=/project/lab1_basic_build/build/lab1_basic_build.map -D OUTPUT_JSON= -P /opt/esp/idf/tools/cmake/run_size_tool.cmake
